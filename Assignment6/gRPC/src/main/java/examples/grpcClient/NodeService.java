...
public class NodeService {
    ...
    private void start() throws IOException {
        ...
        server = ServerBuilder.forPort(port)
                .addService(new example.grpcclient.EchoImpl())
                .addService(new example.grpcclient.JokeImpl())
                .addService(new example.grpcclient.CalcImpl())
                .addService(new example.grpcclient.TipsImpl())
                .addService(new example.grpcclient.TeamImpl())
